...
public class PatientDetailActivity extends Activity {
    ...
    private RecyclerView recyclerBloodPressure, recyclerBodyTemperature, recyclerAllergies;
    private VitalsHistoryAdapter bloodPressureAdapter, bodyTemperatureAdapter;
    private AllergiesHistoryAdapter allergiesAdapter;
    private List<Vital> bloodPressureHistory, bodyTemperatureHistory;
